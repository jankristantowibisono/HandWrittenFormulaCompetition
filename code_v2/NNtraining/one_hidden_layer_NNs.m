...
load Training_data_hw5.mat;
load Test_data4_hw5.mat;
%% settings
eta = 0.0000001;
...
title({['Cross Error Entropy of Training Data '];['eta=', num2str(0.0001),...
    ', hidden size = ',num2str(size_1),...
    ', epoch=',int2str(MaxIter)]});
saveas(gcf,['Cross Eroor Entropy of Training Data ','eta=', num2str(0.0001),...
    ' hidden size = ',num2str(size_1),' epoch=',int2str(MaxIter),'.png']);
figure, 
plot(acc(1:iter),'color','b');
xlabel('Iterations');
ylabel('Accuracy');
title({['Accuracy of Training Data '];['eta=', num2str(0.0001),...
    ', hidden size = ',num2str(size_1),...
    ', epoch=',int2str(MaxIter)]});
saveas(gcf,['Accuracy of Training Data ','eta=', num2str(0.0001),...
    ' hidden size = ',num2str(size_1),' epoch=',int2str(MaxIter),'.png'])
...
save OneHidNN_T_test.mat T_test;
